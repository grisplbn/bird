...
{
    // --- Flaga globalna (domyślnie OFF; możesz zmienić na true jeśli chcesz)
    ...
    // --- Flaga per-test; AsyncLocal => izolacja dla równoległych testów
    ...
    // ------- JSON pretty options (wspólne dla wszystkich)
    ...
    // ======= Public helpers, gotowe do użycia w *Helpers.cs
